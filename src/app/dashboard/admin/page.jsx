  ...
  const quickLinks = [
    {
      ...
      icon: "👥",
      label: "Manage Users",
      desc: `${stats.totalUsers + stats.totalArtists} total`,
      color: "bg-blue-50 dark:bg-blue-950/30 border-blue-100",
    },
    {
      href: "/dashboard/admin/artworks",
      icon: "🖼",
      label: "Manage Artworks",
      desc: `${stats.totalArtworks} artworks`,
      color: "bg-amber-50 dark:bg-amber-950/30 border-amber-100",
    },
    {
      href: "/dashboard/admin/transactions",
      icon: "💳",
      label: "Transactions",
      desc: `$${stats.totalRevenue.toFixed(0)} revenue`,
      color: "bg-emerald-50 dark:bg-emerald-950/30 border-emerald-100",
    },
    {
      ...
      color: "bg-violet-50 dark:bg-violet-950/30 border-violet-100",
    },
  ];
